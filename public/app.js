(function(){
  ...
  function persistState(){
    try{
      const obj = {
        inflationText: els.inflationText.value,
        usdtryText: els.usdtryText.value,
  ...
  function restoreState(){
    try{
      ...
      if(state.inflationText) els.inflationText.value = state.inflationText;
      if(state.usdtryText) els.usdtryText.value = state.usdtryText;
